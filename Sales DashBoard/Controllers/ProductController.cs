...
namespace Sales_DashBoard.Controllers
{
    public class ProductController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProductId,Name,Price,BrandId")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductId,Name,Price,BrandId")] Product product)
        {
            ...
            ViewData["BrandId"] = new SelectList(_context.Brands, "BrandId", "Namee", product.BrandId);
            return View(product);
        }
